...
<section class="mb-10 mt-10 min-h-screen ">
    ...
    <section class="relative z-10 w-96 md:w-1/3 text-justify mx-auto mt-3 md:mb-5 flex flex-col md:flex-row justify-evenly">
        <img src="/developer_picture.jpg" alt="will vincent parrone" class="md:h-96 rounded-2xl mt-5"/>
    ...
    <section class="flex flex-col items-center mx-auto">
        <section class=" text-justify mb-5 mx-auto w-96 md:w-5/12 md:mb-0 ">
            <p class="relative z-10 text-lg text-justify"> 
                I have built an expertise using various languages such as javascript, python, rust, and the likes. Attached within are the original projects that I have worked on or are still currently being worked on.
            </p>
